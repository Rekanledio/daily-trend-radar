...
// ---------------------------------------------------------------------------
// Helpers (duplicated from page.tsx so TrendExplorer is self-contained)
// ---------------------------------------------------------------------------
...
/** Parse published_at to epoch ms for sorting. Invalid → 0 so it sinks to bottom. */
...
export default function TrendExplorer({ trends }: { trends: Trend[] }) {
  ...
  // Apply search + filters + sort in a single useMemo
